    ...
    <div className="flex-col items-start justify-center min-h-screen bg-gray-200 pb-20">
      ...
      <div className="flex justify-center mt-5">
        <div className="inline-flex rounded-full overflow-hidden shadow-md border border-gray-500">
          ...
          <button className="bg-gray-500 text-white px-6 py-2 text-sm md:text-base font-medium rounded-r-full">
            Hutang
          </button>
        </div>
      </div>
        ...
        >
          ...
          >
            ...
            <option value="piutang">
              Piutang (Orang lain berhutang ke saya)
            </option>
          </select>
          <input
            name="due_date"
          ...
          <tbody>
            {data.map((item) => (
              <tr
                key={item.id}
                className={
                  isDueSoon(item.due_date) && item.status === "belum lunas"
                    ? "bg-yellow-100"
                    : ""
                }
              >
                ...
                <td className="p-2 border-b">
                  <span
                    className={`text-white text-xs px-2 py-1 rounded ${
                      item.type === "hutang" ? "bg-red-500" : "bg-blue-500"
                    }`}
                  >
